...
--Asociación Espacial de Eventos (RF-09)
ALTER TABLE eventos
    ADD COLUMN id_ubicacion INT REFERENCES ubicaciones(id_ubicacion);

--Reporte Analítico de Ocupación y Demanda de Espacios (RF-10)
CREATE VIEW vista_ranking_ubicaciones AS
SELECT u.id_ubicacion, u.nombre,
...
--Modulo de tareas asociadas a eventos:
SET search_path TO prototipo, public;

--Tabla de tareas (RF-15)
CREATE TABLE tareas (
